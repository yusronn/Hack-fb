...
white='\033[37;1m'
yellow='\033[33;1m
#################################################### CTRL C-###################################################trap ctrl_c INTctrl_c() {clear
...
sleep 1
echo ""
echo $white"[#]> BlackHat Hacker Indonesia "read enter
exit
}
echo 
____________________________________________" | lolcatecho $green"kontak admin:www.joness45.zone.id"
echo $Orange"Author: Mr.J0N3$$\"echo $Red"Thanks BlackHat Hacker Indonesia "echo "___________________________________________" | lolcat
echo $green" 01) Singgle ID Target Kalian  "
echo $green" 02) Langkah Sebelum Menggunakan Tools"
echo $green" 03) Info Tools"read -p "[BlackHat Hacker Indonesia ]> " bro;
...
then
clear
echo $green"Author : Mr.J0N3$$\"  
echo $green"Hahhahahahahahahahahahaha Mampuus Data-Data Handphone Kalian Ke Resett Hahahahahahaha"
echo $green"Unchhhhh Sabar Ae Babi hahahahahahahaha Mampus Kalian Semua Ahhahaahhahaha "
echo $green"ThanksTo; Mr SoUrchID"
echo $green"ThanksTo; Mr.F3eLL"
echo $green"ThanksTo;Omest"
echo $green"ThanksTo;M4R5H4LL"
echo $green"ThanksTo;Tuan Swam"
echo $red"BlackHat Hacker Indonesia "
exit 
fi